...
public interface ViewInfiniteBuyDailyMapper {
     ...
     * This method corresponds to the database table aventador.view_infinite_buy_daily
     *
     ...
     * @mbg.generated Wed Dec 15 13:59:06 KST 2021
     */
    int updateByExampleSelective(@Param("record") ViewInfiniteBuyDaily record, @Param("example") ViewInfiniteBuyDailyExample example);
     ...
     * @mbg.generated Wed Dec 15 13:59:06 KST 2021
     */
    int updateByExample(@Param("record") ViewInfiniteBuyDaily record, @Param("example") ViewInfiniteBuyDailyExample example);
}